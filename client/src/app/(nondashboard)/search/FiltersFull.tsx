      ...
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <Button
              ...
              className="rounded-r-xl rounded-l-none border-l-none border-black shadow-none border hover:bg-[#27272a] hover:text-[#fcfcfc]"
            >
        ...
        <div className="flex gap-4 mt-6">
          <Button
            ...
            className="cursor-pointer flex-1 bg-[#27272a] text-white rounded-xl"
          >
            APPLY
          </Button>
          <Button
            onClick={handleReset}
            variant="outline"
            className="cursor-pointer flex-1 rounded-xl"
          >
            Reset Filters
          </Button>
        </div>
