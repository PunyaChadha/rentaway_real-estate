  ...
  return (
    <div className="mb-6">
      ...
      <div className="mt-12 mb-16">
        <h3 className="text-xl font-semibold text-[#111113] dark:text-[#f1f1f2]">
          Highlights
        </h3>
          ...
          {property.highlights.map((highlight: HighlightEnum) => {
            ...
            return (
              <div
                ...
                className="flex flex-col items-center border rounded-xl py-8 px-4"
              >
                <Icon className="w-8 h-8 mb-2 text-[#57575f] dark:text-[#c7c7cc]" />
                <span className="text-sm text-center text-[#57575f] dark:text-[#c7c7cc]">
      ...
      {/* Tabs Section */}
      <div>
        <h3 className="text-xl font-semibold text-[#111113] dark:text-[#f1f1f2] mb-5">
          Fees and Policies
        </h3>
        <p className="text-sm text-[#57575f] dark:text-[#c7c7cc] mt-2">
        ...
        <Tabs defaultValue="required-fees" className="mt-8">
          ...
          <TabsContent value="required-fees" className="w-1/3">
            ...
            <hr />
            <div className="flex justify-between py-2 bg-[#fefcfc]">
