...
const DiscoverSection = () => {
  return (
    ...
    >
      <div className="max-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 xl:px-16">
        <motion.div
...
const DiscoverCard = ({
  ...
  <div className="px-4 py-12 shadow-lg rounded-lg bg-[#fcfcfc] md:h-72">
    <div className="bg-[#27272a] p-[0.6rem] rounded-full mb-4 h-10 w-10 mx-auto">
      <Image
        src={imageSrc}
        width={30} height={30}
        className="w-full h-full" alt={title}
      />
    </div>
