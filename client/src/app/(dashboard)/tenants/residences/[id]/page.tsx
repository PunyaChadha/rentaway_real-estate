      ...
      <div className="border rounded-lg p-6">
        <div>
            ...
            <div className="flex flex-col justify-between">
              <div>
                <div className="flex items-start gap-5">
                  ...
                  <span className="text-sm font-medium border border-[#27272a] text-[#27272a] px-3 py-1 rounded-full">
                    Default
                  </span>
                </div>
          ...
          <div className="flex justify-end">
            <button className="bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center hover:bg-[#27272a] hover:text-[#fcfcfc]">
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 flex-1 flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="border-[0.5px] border-[#c7c7cc] h-4" />
          <div className="xl:flex">
          ...
          <TableBody>
            {payments.map((payment) => (
              <TableRow key={payment.id} className="h-16">
                ...
                <TableCell>
                  <button className="border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center font-semibold hover:bg-[#27272a] hover:text-[#fcfcfc]">
