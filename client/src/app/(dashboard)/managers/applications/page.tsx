                  ...
                  <div className="flex justify-between gap-5 w-full pb-4 px-4">
                    ...
                    <div className="flex gap-2">
                      <Link
                        ...
                        className={`bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center hover:bg-[#27272a] hover:text-[#fcfcfc]`}
                        scroll={false}
                      >
                      ...
                      {application.status === "Denied" && (
                        <button
                          className={`bg-gray-800 text-white py-2 px-4 rounded-md flex items-center justify-center hover:bg-[#eb8686] hover:text-[#fcfcfc]`}
                        >
                          Contact User
                        </button>
                      )}
